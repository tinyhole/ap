...
func (c *helloService) SayHello(ctx context.Context, in *SayHelloReq, opts ...client.CallOption) (*SayHelloRsp, error) {
...
func (h *helloHandler) SayHello(ctx context.Context, in *SayHelloReq, out *SayHelloRsp) error {
